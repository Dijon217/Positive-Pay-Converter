...
import Service.PositivePayService;
...
//        SwingUtilities.invokeLater(() -> new FileChooserApp().createAndShowGUI());
//    }
    ...
    public void createAndShowGUI() {
        ...
        runButton.addActionListener(e -> {
            ...
            String[] pathArray = positivePayService.convertListPositivePayFormat(importPath,exportPath);
