package com.dijon.positivepay.positivepayconverter.model;
...
public class PositivePayRecordModel implements Comparable<PositivePayRecordModel> {
    ...
    public PositivePayRecordModel(String bankDescription, String accountNumber, double amount,
                                  String paymentNumber, LocalDate postDate, String payeeName) {
        ...
        if (isNullOrEmpty(bankDescription) || isNullOrEmpty(accountNumber) ||
                ...
                isNullOrEmpty(payeeName) || isNullOrEmpty(String.valueOf(amount))) {
            throw new IllegalArgumentException("Missing required field(s) in CSV record to create PositivePayRecordModel.");
        }
    }
